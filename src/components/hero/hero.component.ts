...
@Component({
  ...
  template: `
    <section id="home" class="relative pt-28 pb-20 lg:pt-36 lg:pb-32 overflow-hidden">
      <!-- Background pattern with Berlin-inspired elements -->
      <div class="absolute top-0 left-0 w-full h-full opacity-10 dark:opacity-5 z-0">
        <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-primary-100 to-transparent"></div>
        <div class="absolute top-0 left-0 w-full h-full">
          <svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
            <defs>
              <pattern id="grid" width="8" height="8" patternUnits="userSpaceOnUse">
                <path d="M 8 0 L 0 0 0 8" fill="none" stroke="currentColor" stroke-width="0.5" opacity="0.5" />
              </pattern>
            </defs>
      ...
      <div class="container mx-auto px-4 relative z-10">
        <div class="md:flex md:items-center md:justify-between md:space-x-10">
          <div class="md:w-1/2 mb-10 md:mb-0">
            ...
            <p class="text-xl md:text-2xl mb-6 text-gray-700 dark:text-gray-300">
            ...
            <div class="mb-8 text-gray-600 dark:text-gray-400">
              ...
              <div class="flex items-start mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 mt-1 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <a href="#schedule" class="inline-block px-6 py-3 font-medium rounded-md transition-all bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white hover:bg-gray-300 dark:hover:bg-gray-600 text-center">
                View Schedule
              </a>
            </div>
          </div>
          ...
          <div class="md:w-1/2 relative">
            <div class="relative overflow-hidden rounded-lg shadow-2xl">
              <div class="w-full h-full absolute top-0 left-0 bg-gradient-to-br from-primary-500/20 to-secondary-500/20 z-10"></div>
              <img 
            ...
            <div class="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 rounded-full p-4 shadow-lg flex items-center justify-center">
