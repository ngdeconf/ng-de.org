    ...
    <section class="py-20 bg-gray-50 dark:bg-gray-900">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-4xl font-bold mb-4">Conference Overview</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <!-- Workshop Day -->
          <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden group hover:shadow-xl transition-all">
            ...
            <div class="p-8">
              <div class="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p class="text-gray-500 dark:text-gray-400">November 5, 2025</p>
                </div>
              </div>
              <p class="text-gray-600 dark:text-gray-300 mb-6">
                Full-day hands-on workshops with Angular experts. Deep dive into specific topics and get practical experience.
              </p>
          ...
          <!-- Conference Day 1 -->
          <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden group hover:shadow-xl transition-all">
            <div class="absolute top-0 left-0 w-full h-1 bg-secondary-500"></div>
            <div class="p-8">
              <div class="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p class="text-gray-500 dark:text-gray-400">November 6, 2025</p>
                </div>
              </div>
              <p class="text-gray-600 dark:text-gray-300 mb-6">
                First day of the main conference with keynote talks, technical sessions, and networking opportunities.
              </p>
              <ul class="space-y-3 mb-6">
                <li class="flex items-center">
          ...
          <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden group hover:shadow-xl transition-all">
            ...
            <div class="p-8">
              <div class="flex items-center mb-4">
                <div class="w-12 h-12 bg-accent-100 dark:bg-accent-900 rounded-full flex items-center justify-center mr-4">
                ...
                <div>
                  ...
                  <p class="text-gray-500 dark:text-gray-400">November 7, 2025</p>
                </div>
              </div>
              <p class="text-gray-600 dark:text-gray-300 mb-6">
                Second day featuring more technical talks, panel discussions, and closing ceremony.
              </p>
              <ul class="space-y-3 mb-6">
                <li class="flex items-center">
