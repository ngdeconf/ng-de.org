      ...
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
          ...
          <div class="prose dark:prose-invert max-w-none">
            ...
            <h2 class="text-2xl font-bold mb-4">Responsible for data protection</h2>
            <p class="mb-6">
              Symetics GmbH<br>
              c/o CIC<br>
              Lohmühlenstraße 65<br>
            ...
            <p class="mb-6">
              Github is a cloud service provider and content delivery network. Here we host and operate our website. Legal basis for using GitHub on our website is the privacy shield framework. We may process your personal data until our legitimate interest ceases to exist.
            </p>
            <p class="mb-6">
              For more details of Githubs privacy and security processes, please visit <a href="https://help.github.com/articles/github-privacy-statement/" class="text-primary-500 hover:text-primary-600" target="_blank" rel="noopener noreferrer">GitHub Privacy Statement</a>.
            </p>

            <h2 class="text-2xl font-bold mb-4">Rights according to legal data protection regulations</h2>
            <p class="mb-4">
            ...
            <ul class="list-disc pl-6 mb-6">
              ...
              <li>Right to correct any information that is inaccurate or incomplete according to Art. 16 GDPR</li>
              <li>Right to Deletion according to Art. 17 GDPR</li>
              <li>Right to limitation of processing according to Art. 18 GDPR</li>
            ...
            <p class="mb-6">
              We hereby expressly distance ourselves from all contents of these sites to which links are established and do not adopt these contents as our own. We do not have any influence on changes of the linked content.
            </p>
            ...
            <p class="mb-6">
              Our website uses the map service Google Maps via an API. The provider is Google Inc, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA. To use the functions of Google Maps it is necessary to save your IP address.
            </p>
