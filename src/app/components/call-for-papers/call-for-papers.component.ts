          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
            ...
            <ul class="space-y-4">
              ...
              <li class="flex items-start">
                ...
                <span>We won't do any Q&A, but if you want to have one it should not exceed your 30 minute slot</span>
              </li>
              <li class="flex items-start">
                <svg class="w-6 h-6 text-primary-500 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
              ...
              <li class="flex items-start">
                ...
                <span>By submitting a talk you agree with our Code of Conduct and Privacy Policy</span>
              </li>
              <li class="flex items-start">
                <svg class="w-6 h-6 text-primary-500 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
            ...
            <ul class="space-y-4">
              ...
              <li class="flex items-start">
                ...
                <span>Latest Innovations in Angular (Signals, Hydration, Vite, esbuild)</span>
              </li>
              <li class="flex items-start">
                <svg class="w-6 h-6 text-primary-500 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
        ...
        <div class="mt-12 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          ...
          <ul class="space-y-4 mb-8">
            <li class="flex items-start">
              ...
              <span>50% of the talks will be pre-selected to ensure a balanced program covering key topics and speakers</span>
            </li>
            <li class="flex items-start">
              <svg class="w-6 h-6 text-primary-500 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
              </svg>
              <span>The remaining 50% will be selected through our jury process</span>
            </li>
            <li class="flex items-start">
              <svg class="w-6 h-6 text-primary-500 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
              </svg>
              <span>All submissions will be anonymized to ensure unbiased evaluation</span>
            </li>
            <li class="flex items-start">
              <svg class="w-6 h-6 text-primary-500 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
              </svg>
              <span>The jury will review and vote on submissions based on content quality, relevance, and potential impact</span>
            </li>
            <li class="flex items-start">
              <svg class="w-6 h-6 text-primary-500 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
              </svg>
              <span>Final selections will be made considering both the pre-selected talks and jury recommendations</span>
            </li>
          </ul>
        </div>
