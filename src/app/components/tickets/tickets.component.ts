    ...
    <section id="tickets" class="py-20 bg-gray-50 dark:bg-gray-900">
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div
            class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-transform hover:scale-105 border-t-4 grid grid-rows-[1fr_auto]"
              ...
              <ul class="mb-8 space-y-3">
                ...
                <li class="flex items-start">
                  <svg
                    ...
                    class="h-5 w-5 mr-2 text-primary-500 mt-0.5"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
